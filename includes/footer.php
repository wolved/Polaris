<!-- 
    Footer Module
    Herbruikbare footer. Wordt ingeladen onderaan elke pagina.
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <p class="text-sm leading-relaxed max-w-xs">
                    Centraal interventie- en meldingsportaal voor efficiënt operationeel beheer en coördinatie.
                </p>
            </div>

            <!-- Kolom 2: Snelle links -->
            <div>
                <h3 class="text-white font-semibold text-sm uppercase tracking-wider mb-4">Navigatie</h3>
                <ul class="space-y-2">
