 ...
 * Bevat: stat cards, recente meldingen tabel, snelle acties.
 * !nog niet afgewerkt
 */
...
$recenteMeldingen = [
    ['id' => 'M-2026-0147', 'type' => 'Inbraak', 'locatie' => 'Koningsstraat 42, Brussel', 'tijd' => '14:23', 'status' => 'Open', 'prioriteit' => 'Hoog'],
    ['id' => 'M-2026-0146', 'type' => 'Verkeersongeval', 'locatie' => 'E40 afrit 21, Leuven', 'tijd' => '13:45', 'status' => 'In behandeling', 'prioriteit' => 'Hoog'],
    ['id' => 'M-2026-0145', 'type' => 'Geluidsoverlast', 'locatie' => 'Marktplein 7, Gent', 'tijd' => '12:30', 'status' => 'In behandeling', 'prioriteit' => 'Laag'],
    ['id' => 'M-2026-0144', 'type' => 'Winkeldiefstal', 'locatie' => 'Meir 112, Antwerpen', 'tijd' => '11:15', 'status' => 'Afgerond', 'prioriteit' => 'Gemiddeld'],
    ['id' => 'M-2026-0143', 'type' => 'Vandalisme', 'locatie' => 'Stationsplein 3, Mechelen', 'tijd' => '10:02', 'status' => 'Afgerond', 'prioriteit' => 'Laag'],
];
?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
                ...
                <div
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-xs font-medium text-red-500 bg-red-50 px-2 py-1 rounded-full">+3
                            vandaag</span>
                    </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-xs font-medium text-amber-600 bg-amber-50 px-2 py-1 rounded-full">5
                            actief</span>
                    </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-xs font-medium text-blue-600 bg-blue-50 px-2 py-1 rounded-full">+24 deze
                            maand</span>
                    </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-xs font-medium text-emerald-600 bg-emerald-50 px-2 py-1 rounded-full">3
                            beschikbaar</span>
                    </div>
                    <p class="text-2xl font-bold text-navy-900">38</p>
